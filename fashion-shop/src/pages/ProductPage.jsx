      ...
      <Header/>
        ...
        <main className="main-product">
          <div className="main-product__img">
            <button className="main-product__button button-left">
              <svg
                width={13}
                height={23}
                viewBox="0 0 13 23"
            ...
            <div className="main-product__img__img">
              <img src="/src/assets/main-product.jpg" alt="product" />
            </div>
            <button className="main-product__button button-right">
              <svg
                width={13}
                height={23}
                viewBox="0 0 13 23"
          ...
          <section className="main-product__center center">
            <div className="main-product__info">
              ...
              <p className="main-product__info__text">
              ...
              <div className="main-product__info__features">
                <button className="main-product__info__klick">
                  CHOOSE COLOR{" "}
                  <svg
                    width={11}
                    height={6}
              ...
              <button className="main-product__info__button">
                {" "}
                <svg
                  width={27}
                  height={25}
            ...
            <div className="main-product__bottom__items">
              <div className="product">
                <div className="product__picturebox">
                  ...
                  <img
                    src="/src/assets/main-product__bottom001.jpg"
                    alt="photo 001"
                    className="product__picturebox__img"
                  />
                </div>
                <div className="product__content">
                  <h5 className="product__content__heading">
                  ...
                  <p className="product__content__price">$52.00</p>
                </div>
              </div>
              <div className="product">
                <div className="product__picturebox">
                  ...
                  <img
                    src="/src/assets/main-product__bottom002.jpg"
                    alt="photo 002"
                    className="product__picturebox__img"
                  />
                </div>
              ...
              <div className="product product_del">
                <div className="product__picturebox">
                  <div className="product__picturebox__itemHover">
                    <button className="product__picturebox__buy-button">
                      <img
                  ...
                  <img
                    src="/src/assets/main-product__bottom003.jpg"
                    alt="photo 003"
                    className="product__picturebox__img"
                  />
                </div>
